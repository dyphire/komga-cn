...
#[path = "thumbnails_and_generated/book_media_asset_routes.rs"]
mod book_media_asset_routes;
#[path = "thumbnails_and_generated/book_thumbnail_delete_and_listing.rs"]
mod book_thumbnail_delete_and_listing;
#[path = "thumbnails_and_generated/book_thumbnail_upload.rs"]
mod book_thumbnail_upload;
#[path = "thumbnails_and_generated/generated_thumbnail_persistence.rs"]
mod generated_thumbnail_persistence;
#[path = "thumbnails_and_generated/opds_thumbnail_routes.rs"]
