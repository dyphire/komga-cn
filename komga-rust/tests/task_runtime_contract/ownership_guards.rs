...
#[path = "ownership_guards/external_owned.rs"]
mod external_owned;

#[path = "ownership_guards/book_local_artwork.rs"]
mod book_local_artwork;

#[path = "ownership_guards/series_local_artwork.rs"]
mod series_local_artwork;

#[path = "ownership_guards/series_metadata_providers.rs"]
mod series_metadata_providers;

#[path = "ownership_guards/deletion.rs"]
mod deletion;

#[path = "ownership_guards/hashing.rs"]
mod hashing;

#[path = "ownership_guards/book_thumbnails.rs"]
mod book_thumbnails;

#[path = "ownership_guards/metadata_refresh.rs"]
mod metadata_refresh;

#[path = "ownership_guards/empty_trash.rs"]
mod empty_trash;

#[path = "ownership_guards/main_db_guards.rs"]
mod main_db_guards;
