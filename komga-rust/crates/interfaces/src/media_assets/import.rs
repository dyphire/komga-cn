...
mod tests {
    ...
    async fn test_media_state(task_queue: Arc<dyn TaskQueueAdmin>) -> MediaAssetsState {
        ...
        MediaAssetsState {
            ...
            reader: Arc::new(MediaReader::new(pool.clone())),
            content: Arc::new(ContentResolver),
            thumbnails: Arc::new(ThumbnailWriter::new(pool.clone())),
            progress: Arc::new(ProgressWriter::new(pool.clone())),
