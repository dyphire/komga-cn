...
pub(crate) fn resolve_book_page_bytes_for_tests(
...
pub(crate) fn load_archive_page_rows_for_tests(
    media: &BookMediaRecord,
...
pub(crate) fn load_generated_pdf_page_rows_for_tests(
    media: &BookMediaRecord,
) -> Vec<BookPageRecord> {
...
pub(crate) fn read_pdf_page_as_single_page_pdf_for_tests(
    media: &BookMediaRecord,
    page_number: u64,
) -> Option<Vec<u8>> {
