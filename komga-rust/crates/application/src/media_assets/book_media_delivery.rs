...
use crate::identity_access::{
    AuthUser, user_has_role, user_is_admin, user_shared_all_libraries, user_shared_library_ids,
};
    ...
    B: PersistedBookIdResolverPort + ?Sized,
{
    ...
    async fn user_can_access_book(
        ...
        let context = BookMediaUserContext::from_auth_user(user);
