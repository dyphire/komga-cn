...
pub(super) fn compose_runtime_identity_access_backend() -> RuntimeIdentityAccessBackend {
    RuntimeIdentityAccessBackend {
        ...
        persisted_users: Arc::new(|database_file| {
            Box::pin(async move {
                infrastructure_runtime_identity_access::persisted_users(database_file.as_path())
                    .await
            })
        }),
        ...
        configured_api_key: Arc::new(infrastructure_runtime_identity_access::configured_api_key),
